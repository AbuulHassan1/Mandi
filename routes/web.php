...
//        Route::get('/home', 'Dashboard@index')->name('home');
        ...
        Route::get('/purchaseinvoice','MandiPurchaseController@create')->name('purchase_item');
        ...
        Route::post('/mandi_sale_store','MandiSaleControllr@store');
        Route::get('/SaleList','MandiSaleControllr@list')->name('SaleList');
        Route::any('/saleinvoice/{id}','MandiSaleControllr@saleinvoice');
