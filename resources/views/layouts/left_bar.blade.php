<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{ route('purchase_item') }}" class="nav-link @if(Route::currentRouteName() == 'purchase_item') active @endif">
        ...
        <li class="nav-item">
            <a href="{{ route('createsale') }}" class="nav-link @if(Route::currentRouteName() == 'createsale') active @endif">
                <i class="nav-icon fas fa-shopping-cart"></i>
                <p>
                    Mandi Sale
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('mandi_customer') }}" class="nav-link @if(Route::currentRouteName() == 'mandi_customer') active @endif">
        ...
        <li class="nav-item">
            <a href="{{ route('create_item') }}" class="nav-link @if(Route::currentRouteName() == 'create_item') active @endif">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>
                    Add Item
                </p>
