            ...
            <table id="myTable" class="table table-bordered table-striped">
                ...
                @foreach ($admins as $index => $admin)
                    <tr id="tblrow_{{$admin->id}}">
                        ...
                        <td class="table-actions"><a class="btn btn-primary btn-sm" style="margin-left:5px" href="{{route('adminlist.edit', [$admin->id] )}}"><i class="fa fa-edit"
                                ></i></a> <button type="button" onclick="$('#delete_id').val({{$admin->id}})"
