...
class MandiPurchaseController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        $customers = DB::table('mandi_customer_models')->select('*')->get();

        return view('mandi_purchase.create',compact('customers' , 'items' ), $data);
    }
